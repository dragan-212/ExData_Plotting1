plot2 <- function(outdev = "screen") {
# 
# Program reads in Electric power consumption data set and plots a line graph
# Usage: Plot2() defauts to screen output only
#        Plot2("file") plots to screen and file, Plot1.png
#
...
do_plot <- function() {
    ...
    lines(strptime(dt$DateTime, "%d/%m/%Y %H:%M:%S"), dt$Global_active_power)
}